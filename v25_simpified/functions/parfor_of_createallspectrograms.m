...
function [spectrograms] = parfor_of_createallspectrograms(numberofsamples,reqSNRdB,augmentationtype,type,index,savefile)
...
display(['Spectrogram Number:', num2str(ii),'/',num2str(numberofsamples)]);
