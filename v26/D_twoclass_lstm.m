...
numberofrun=1;
dataname='Traindatatwoclass_13features_30_11_2021_oversampled_normalized_newspectrograms';
...
%     featurevec= [1:iii]; % 6.feature bozuldugu icin bunu tercih ettik
%     featurevec= [1:iii];
...
%    for iii =numberoffeatures:15 % to 15
    featurevec= [1:numberoffeatures]; % 6.feature bozuldugu icin bunu tercih ettik
%     featurevec= [1:iii];
